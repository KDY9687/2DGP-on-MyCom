...
class WalkingState:
    ...
    def do(boy):
        ...
        boy.x = clamp((boy.y + 87) / 6, boy.x, (6556 - boy.y) / 6 + 725)
        boy.y = clamp(75, boy.y, 1086)
...
class Boy:
    ...
    def draw(self):
        ...
        self.font.draw(self.x - self.bg.window_left - 60, self.y - self.bg.window_bottom + 60, '(%5d, %5d)' % (self.x, self.y), (255, 255, 0))
